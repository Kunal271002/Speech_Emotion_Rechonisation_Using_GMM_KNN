...
*/
  ...
  12084: function (t, e, n) {
    ...
    Object.defineProperty(i.prototype, "currentAnimation", {
      ...
      (i.prototype.calcFixed = function (t, e, n) {
        if (!e.fixed)
          return (this.state._unfixedDist += this.global.vh * e.dist), void 0;
        if (t === s)
    ...
    (t.exports = i),
      ...
      (i.prototype.updateTotalPrice = function t(e) {
        ...
        if (n.length) {
          ...
          if (
            ((a = i.prototype.addZeroCents(a, s)),
            n.text(a + " " + currency),
            !this.isCart)
          )
      ...
      (i.prototype.createTotalPrice = function t(e, n, data) {
        ...
        if (
          (l.text(
            i.prototype.addZeroCents(data.price, data.addZeroCents) +
              " " +
              data.currency
          ),
          s.append(l),
      ...
      (i.prototype.fillItem = function t(e, product) {
        ...
        c.parent().empty().append(h),
          e
            .find(".u-product-quantity input")
            .attr({ value: s, "data-product-id": id }),
  ...
  12136: function (t, e, n) {
    ...
    (ProductsBuilder.prototype.build = function (page, sorting, t) {
      ...
      var template = this.list.find(".u-repeater").children().eq(0).clone(),
        ...
        n =
          parseFloat(this.list.attr("data-max-items")) ||
          parseFloat(this.list.attr("data-items-per-page")) ||
          3,
  ...
  356: function (t, e) {
    t.exports = [
      ...
      { name: "Swiss franc", code: "CHF", symbol: "fr.", locale: "fr-CH" },
      ...
      (HorizontalLayoutSlider.prototype.navigate = function (t) {
        if (!t.hasClass("u-hidden") && this.viewport) {
          ...
          this.viewport.animate(
            { scrollLeft: n },
            500 * (Math.abs(this.data.offset - n) / i),
            "swing"
          );
        }
      }),
